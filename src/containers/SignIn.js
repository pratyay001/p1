  ...
  return (
    ...
    <Col sm="5"  mr="0" ml="0" style={{paddingLeft:'0px',height:'800px',backgroundColor:'#f4b41a',paddingTop:'50px'}}>
      ...
      <div className="Title-Copy">
               <NavLink to="/" activeClassName="FormTitle__Link--Active" className="FormTitle__Link"  style={{paddingLeft:'55px',color: '#666666',fontSize:'14px',textDecoration:'none',paddingBottom:'14px'}}>Sign Up</NavLink>
               &nbsp;&nbsp;&nbsp;
               <NavLink exact to="/sign-in" activeClassName="FormTitle__Link--Active" className="FormTitle__Link" style={{fontSize:'14px',color:'#0e2536',textDecoration:'none', borderBottom: '3px solid #f4b41a',marginLeft:'0',paddingBottom:'14px'}} >Sign In</NavLink> 
                            ...
                            <Row>
                                <Col span="12" style={{paddingLeft:'35px',fontSize:'12px',display:'flexs',fontWeight:'normal',color:'#999999',position:'relative',bottom:'40px'}}>
                                    <Input 
                                        type="checkbox"
                                        name="rememberMe"
                                    /> Remember Me <Link to="/forgot" style={{textDecoration:'none',color:'#666666',paddingBottom:'50px'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Forgot Password</Link>
                                </Col>
                            </Row>
                        </FormGroup>
            </Form>  
            <div>
            <ButtonToggle color="warning" type="button" style={{position:'relative',bottom:'20px',borderRadius:'4px',width:'295px',height:'40px',fontWeight:'bold',fontSize:"14px",left:'55px',textAlign:"center"}}><NavLink exact to="/sign-in" style={{ textDecoration: 'none',color:'#133047'}}>&nbsp;&nbsp; Sign In </NavLink> 
             </ButtonToggle>
             </div>
      </div>
    </Col>
