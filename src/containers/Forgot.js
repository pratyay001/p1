  ...
  return (
    ...
    <Col sm="5"  mr="0" ml="0" style={{paddingLeft:'0px',height:'800px',backgroundColor:'#f4b41a',paddingTop:'50px'}}>
      <div className="Rectangle" style={{width:'400px',height:'600px',paddingRight:'100px',paddingBottom:'50px',boxShadow:'0 2px 4px 0 rgba(0,0,0,0.5)',backgroundColor:'#ffffff'}} >
         ...
         <div className="subheading" style={{fontFamily:'Helvetica',fontSize:'15px',color:'#133047',display:'flex',borderLeft:'3px solid #f4b41a',paddingBottom:'18px'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please type with registered email
            </div>
            <Form className="resetPasswordForm"  style={{paddingLeft:'55px',width:'350px'}}>
                        <FormGroup className="resetPassword-formElements">
                            
                            <Input 
                                type="email" class="form-control is-valid" id="validationServer01"
            ...
            <br></br>
            <div>
            <ButtonToggle color="warning" type="button" style={{position:'relative',bottom:'20px',borderRadius:'4px',width:'295px',height:'40px',fontWeight:'bold',fontSize:"14px",left:'55px',textAlign:"left"}}><NavLink exact to="/forgot-password-confirmation" style={{ textDecoration: 'none',color:'#133047'}}>&nbsp;&nbsp; Submit </NavLink> 
             </ButtonToggle>
             </div>
      </div>
    </Col>
