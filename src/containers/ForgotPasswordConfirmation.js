  ...
  return (
    ...
    <Col sm="5"  mr="0" ml="0" style={{paddingLeft:'0px',height:'800px',backgroundColor:'#f4b41a',paddingTop:'50px'}}>
      <div className="Rectangle" style={{width:'400px',height:'600px',paddingRight:'100px',paddingBottom:'50px',boxShadow:'0 2px 4px 0 rgba(0,0,0,0.5)',backgroundColor:'#ffffff'}} >
         ...
         <div className="subheading" style={{fontFamily:'Helvetica',fontSize:'15px',color:'#133047',lineHeight:'1.43',display:'flex',borderL:'4px solid #f4b41a',paddingLeft:'55px',borderLeft:'4px solid #f4b41a',paddingBottom:'18px'}}>Link sent
            </div>
           <p style={{width:'349px',fontFamily:'Helvetica',fontSize:'12px',color:'#666666',paddingLeft:'55px',paddingBottom:'18px'}}>We have sent a password recovery instruction to your registered email ID</p>
            <div>
            <ButtonToggle color="warning" type="button" style={{position:'relative',bottom:'20px',borderRadius:'4px',width:'295px',height:'40px',fontWeight:'bold',fontSize:"14px",left:'55px',textAlign:"left"}}><NavLink exact to="/reset-password" style={{ textDecoration: 'none',color:'#133047'}}>&nbsp;&nbsp; Okay </NavLink> 
             </ButtonToggle>
             </div>
      </div>
    </Col>
